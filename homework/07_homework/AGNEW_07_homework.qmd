...
Just wanted to add this here below.
...
pp_check(model_quant)  # posterior predictive checks
...
# looks caterpillary (i.e. very hungry)


# Plot the model with credible intervals
model_quant |> 
  spread_draws(b_log_frequency) |> 
  # plot
  ggplot(aes(x = b_log_frequency)) +
    geom_density(fill = "magenta") +
  stat_halfeye() # point median value, thick bar 66% credible interval, thin black bar shows 95% credible interval
